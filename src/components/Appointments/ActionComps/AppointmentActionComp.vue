        ...
        <v-container fluid>
            ...
            <v-row v-if="(!edit.contact || edit.contact.length == 0)" dense class="mt-2">
                <v-col cols="12" class="d-flex flex-column align-start">
                    <fieldset class="w-100 pa-1">
                        ...
                        <span v-if="errors.contact" class="caption red--text">{{ errors.contact }}</span>
                    </fieldset>
                </v-col>
            </v-row>
            ...
            <v-row dense class="mt-2">
                <v-col cols="12" class="d-flex flex-column align-start">
                    ...
                    <span v-if="errors.date" class="caption red--text">{{ errors.date }}</span>
                </v-col>
            </v-row>
    ...
    methods: {
        ...
        searchInContacts(event) {
            ...
            if (event.target.value) {
                ...
                th.tempContacts = th.tempContacts.filter(s => s.SearchString.includes(val))
            }
        },
        ...
        createSearchString() {
            var th = this;
            th.contacts.map(m => {
                m.SearchString = `${m.fields.contact_name}${m.fields.contact_surname}`.toLowerCase();
                return m
            });
        },
        ...
        editFillInputs() {
            ...
            th.model.fields.appointment_date = moment.utc(th.edit.appointment_date).format('YYYY-MM-DD HH:mm:ss');
